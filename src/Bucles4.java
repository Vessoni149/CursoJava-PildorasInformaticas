...
*/
        ...
        //Math.random devuele numeros entre 0  y 1 de tio double.
      ...
      */
        ...
        //sacando el factorial de un numero: el factorial es el resultado de un numero multiplicado por cada numero que lo precede, ej el fact de 4 es: 4*3*3*1
        //si insertamos un numero grande como x ej 20, el tipo int no nos va a alzanzar, si ponemos 50, ni si quiera el tipo Long alcanzaría. Para estos casos se usa una clase BigInteger para manejar numeros muy grandes, pero requieren la construccion de un objeto.
       /* Long resultado = 1L;
...
*/
        ...
        //por cada primer bucle, se va a ejecutar el segunto tantas veces como longitud tenga la segunda dimension, una vez termina sigue con la segunda iteracion del primer bucle y así sucesivamente.
        /*for (int i = 0; i < 3; i++){
            for (int j = 0; j < 4; j++){
