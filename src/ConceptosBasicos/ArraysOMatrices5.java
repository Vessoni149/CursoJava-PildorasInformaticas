...
public class ArraysOMatrices5 {
    ...
    //tipo de dato que almacenara la matriz + [] + nombre de la matriz + = + new + tipo de dato + [n° de valores que
    ...
    //se debe poner entre () el tipo de dato de cada elemento del array y asignar un nombre que represente cada elemento
    // del mismo (en este caso i), seguido de ":" y el nombre  del array a recorrer.
    for (int i: miMatriz) {
